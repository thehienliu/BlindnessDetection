...
class APTOS2019Dataset(Dataset):
  def __init__(self,
    ...
    if download and not exist_dir:
      ...
      raise ValueError("No such file for prepare dataset, please download the dataset first!")
  ...
  def download(root: str=".", force: bool=False) -> None:
    od.download("https://www.kaggle.com/competitions/aptos2019-blindness-detection", data_dir=root, force=force)
  ...
  def split_dataset(self,
    ...
    train_val_data, test_data = train_test_split(data_csv,
